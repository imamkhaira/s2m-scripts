<# 
# UpdateADProfilePicture.ps1
# - A script to update profile picture from active directory
# Created by Imam Khaira (imamkhaira@gmail.com)
...
# enable RPC port 135
Write-Verbose "Enabling Transact-SQL Debugger/RPC port 135"
